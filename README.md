...
- Robustness: log-transformed enrollment tested but reduced separation (silhouette at k=3: 0.321 → 0.268), so raw enrollment was retained; per-sample silhouette showed no negative values in the mega-district cluster; stability confirmed across random seeds (Adjusted Rand Index: 0.994–1.000).
